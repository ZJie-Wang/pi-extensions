...
Part of the [pi-extensions](https://github.com/ZJie-Wang/pi-extensions) collection. This extension works individually, but the collection README is worth reviewing — it covers the design notes, the other extensions, and how to customize the installed files, for example by copying them from `~/.pi/agent/npm/node_modules/@zjie-wang` to maintain them yourself.
